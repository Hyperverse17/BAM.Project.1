<template>
	<div>
		<div :class="{ [$style.cui__sidebar]: true, [$style.cui__sidebar__toggled]: settings.isSidebarOpen }">
			<vue-custom-scrollbar :style="{ height: '100%' }">
				<div :class="$style.cui__sidebar__inner">
					<a href="javascript: void(0);" :class="$style.cui__sidebar__close" class="fe fe-x-circle" @click="toggleSidebar()" />
					<h5>
					...
					<div :class="$style.cui__sidebar__type" class="mb-4">
						...
						<div :class="$style.cui__sidebar__type__items">
							<a-select :defaultValue="settings.routerAnimation" style="width: 100%" @change="selectRouterAnimation">
					...
					<div :class="$style.cui__sidebar__item">
						...
						<div :class="$style.cui__sidebar__container">
							<a-switch :checked="settings.isMenuCollapsed" @click="settingChange($event, 'isMenuCollapsed')" />
						</div>
					</div>
					<div :class="$style.cui__sidebar__item">
						<div :class="$style.cui__sidebar__label">Left Menu: Unfixed</div>
						<div :class="$style.cui__sidebar__container">
							<a-switch :checked="settings.isMenuUnfixed" @click="settingChange($event, 'isMenuUnfixed')" />
						</div>
					</div>
					<div :class="$style.cui__sidebar__item">
					...
					<div :class="$style.cui__sidebar__item">
						...
						<div :class="$style.cui__sidebar__container">
							<air-color-picker :value="settings.menuColor" :setting="'menuColor'" :colors="['white', 'gray', 'dark']" />
						</div>
					</div>
					<div :class="$style.cui__sidebar__item">
						<div :class="$style.cui__sidebar__label">Auth: Background</div>
						<div :class="$style.cui__sidebar__container">
							<air-color-picker :value="settings.authPagesColor" :setting="'authPagesColor'" :colors="['white', 'gray', 'image']" />
						</div>
					</div>
					<div :class="$style.cui__sidebar__item">
						<div :class="$style.cui__sidebar__label">Topbar: Fixed</div>
						<div :class="$style.cui__sidebar__container">
							<a-switch :checked="settings.isTopbarFixed" @click="settingChange($event, 'isTopbarFixed')" />
						</div>
					</div>
					<div :class="$style.cui__sidebar__item">
						<div :class="$style.cui__sidebar__label">Topbar: Gray Background</div>
						<div :class="$style.cui__sidebar__container">
							<a-switch :checked="settings.isGrayTopbar" @click="settingChange($event, 'isGrayTopbar')" />
						</div>
					</div>
					...
					<div :class="$style.cui__sidebar__item">
						...
						<div :class="$style.cui__sidebar__container">
							<a-switch :checked="settings.isContentMaxWidth" @click="settingChange($event, 'isContentMaxWidth')" />
						</div>
					</div>
					<div :class="$style.cui__sidebar__item">
						<div :class="$style.cui__sidebar__label">App: Max-Width</div>
						<div :class="$style.cui__sidebar__container">
							<a-switch :checked="settings.isAppMaxWidth" @click="settingChange($event, 'isAppMaxWidth')" />
						</div>
					</div>
					<div :class="$style.cui__sidebar__item">
						<div :class="$style.cui__sidebar__label">App: Gray Background</div>
						<div :class="$style.cui__sidebar__container">
							<a-switch :checked="settings.isGrayBackground" @click="settingChange($event, 'isGrayBackground')" />
						</div>
					</div>
					<div :class="$style.cui__sidebar__item">
						<div :class="$style.cui__sidebar__label">Cards: Squared Borders</div>
						<div :class="$style.cui__sidebar__container">
							<a-switch :checked="settings.isSquaredBorders" @click="settingChange($event, 'isSquaredBorders')" />
						</div>
					</div>
					<div :class="$style.cui__sidebar__item">
						<div :class="$style.cui__sidebar__label">Cards: Shadow</div>
						<div :class="$style.cui__sidebar__container">
							<a-switch :checked="settings.isCardShadow" @click="settingChange($event, 'isCardShadow')" />
						</div>
					</div>
					<div :class="$style.cui__sidebar__item">
		...
		<a-tooltip placement="left">
			...
			<a href="javascript: void(0);" @click="toggleSidebar()" style="bottom: calc(50% + 120px)" :class="$style.cui__sidebar__toggleButton">
		...
		<a-tooltip placement="left">
			...
			<a href="javascript: void(0);" @click="setTheme(settings.theme === 'default' ? 'dark' : 'default')" style="bottom: calc(50% + 60px)" :class="$style.cui__sidebar__toggleButton">
		...
		<a-tooltip placement="left">
			...
			>
				...
				<input type="color" id="colorPicker" @change="(e) => selectColor(e.target.value)" v-model="settings.primaryColor" />
		...
		<a-tooltip placement="left">
			...
			<a href="https://docs.cleanuitemplate.com" target="_blank" rel="noopener noreferrer" style="bottom: calc(50% - 60px)" :class="$style.cui__sidebar__toggleButton">
